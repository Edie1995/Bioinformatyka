...
function [] = chooseInputMethod(miss,match,gap,path,jpgFileName,txtFileName,varargin)
...
drawMatrix(firstMatrix,aligmentMatrix,fasta1.identifier,fasta2.identifier);
